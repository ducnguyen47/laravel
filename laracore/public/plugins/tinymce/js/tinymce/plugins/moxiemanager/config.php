...
// Filesystem
$moxieManagerConfig['filesystem.rootpath'] = '/var/www/Laracore/laracore/public/images';
...
$moxieManagerConfig['filesystem.extensions'] = 'jpg,jpeg,png,gif,html,htm,txt,docx,doc,zip,rar,pdf,psd,mp3,aac,m4a,mp4,wav,ogg,mov';
...
// $moxieManagerConfig['SessionAuthenticator.config_prefix'] = 'vietpt';
// $moxieManagerConfig['SessionAuthenticator.session_name'] = 'DESSESS';
